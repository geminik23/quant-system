...
| Search a strategy's parameter space and compare in and out of sample | [`qs-research` guide](docs/research.md) | Library-only; tick-driven search |
