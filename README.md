...
- `qs-backtest` provides validated historical strategy contracts plus bounded causal fixed-duration closed-bar series derived from complete primary-tick timestamp batches. Stateful historical strategy callbacks and dynamic FutureQuote strategy integration are not implemented yet.
